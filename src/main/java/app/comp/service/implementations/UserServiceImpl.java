...
import app.comp.repository.systemRepository.UserRepository;
import app.comp.repository.systemRepository.VerificationTokenRepository;
import app.comp.service.interfaces.UserService;
import app.comp.util.exceptions.EmailExistsException;
import app.comp.util.exceptions.UserIdNotFoundException;
...
//    }
    ...
    @Override
    public <S extends app.comp.entity.system.VerificationToken> S save(S entity) {
